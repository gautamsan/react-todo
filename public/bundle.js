...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var TodoList = __webpack_require__(208);
	var TodoContainer = __webpack_require__(213);
	var CategoryContainer = __webpack_require__(212);
	...
	var Main = React.createClass({
	  ...
	  addCategory: function addCategory(cat) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(TodoContainer, { todos: this.state.todosInCat }),
	      React.createElement(CategoryContainer, { addCategory: this.addCategory,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var AddCategory = __webpack_require__(210);
	...
	var CategoryList = React.createClass({
	  ...
	  addCat: function addCat(catToAdd) {
	  ...
	  showCat: function showCat(catToAdd) {
	    this.props.showCategory(catToAdd);
	  },

	  deleteCat: function deleteCat(index, event) {
	  ...
	  render: function render() {
	    ...
	    var lists = this.props.categories.map(function (category, index) {
	      return React.createElement(
	        ...
	        React.createElement(
	          'button',
	          { onClick: that.deleteCat.bind(that, index) },
	          'Delete'
	        ),
	        React.createElement(
	          'button',
	          { onClick: that.showCat.bind(that, category) },
	          'Show todos'
	        )
	      );
	    });
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(AddCategory, { addCat: this.addCat }),
	      React.createElement(
	        'div',
	...
	var AddCategory = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'text', placeholder: 'Enter Category', ref: 'category' }),
	      React.createElement(
	        'button',
	        { type: 'submit' },
	        'Add'
	...
	var AddTodo = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'text', className: '', placeholder: 'Add Todo...', ref: this.setRef }),
	      React.createElement(
	        'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CategoryList = __webpack_require__(209);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var AddTodo = __webpack_require__(211);
	var TodoList = __webpack_require__(208);
